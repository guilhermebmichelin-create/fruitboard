...
used as merged evidence. Draft #111's tested source `05fb35c`, reviewed report
revision `ef08522`, and current hardening head `f8140349` are therefore
provisional: its durable diagnostic and desktop scan-console mapping changes
are not part of merged `3ebac5f`.
