...
tree at `37cd6c...`; at review time the focused #112 corrections recorded here
were separate from Agent 1's packet. They were later replayed into the final
integration candidate, so this file is historical provenance for the earlier
review and is not the approval record for the later candidate SHA.
