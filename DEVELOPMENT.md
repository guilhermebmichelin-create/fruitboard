...
The Phase 0 epic is GitHub issue #1, with review units #2–#5 and stacked PRs
#6–#9. The proposed Phase 1 set remains in [ROADMAP.md](ROADMAP.md); create it
only after architecture review.
